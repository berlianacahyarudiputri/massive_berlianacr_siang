...
function Contact() {
  ...
  return (
    <>
      <HelmetProvider>
        <Helmet>
          <title>Berliana CR - Contact</title>
        </Helmet>
      </HelmetProvider>
            ...
            <div className="row">
              <div className="col contact-col animate__animated animate__slideInLeft">
                <div className="email-wrapper">
                  ...
                  <p>berrlyanax8@gmail.com</p>
                  <CopyToClipboard text="berrlyanax8@gmail.com">
              ...
              <div className="col contact-col animate__animated animate__slideInRight">
                <div className="linkedin-wrapper">
                  ...
                  <p>Berliana Cahya Rudiputri</p>
                  <a
                    href="https://www.linkedin.com/in/berliana-cahya-rudiputri-77133a25b/"
                    target="_blank"
                    rel="noreferrer"
              ...
              <div className="col contact-col animate__animated animate__slideInLeft">
                <div className="github-wrapper">
                  ...
                  <p>berlianacahyarudiputri</p>
                  <a
                    href="https://github.com/berlianacahyarudiputri"
                    target="_blank"
                    rel="noreferrer"
                    className="btn-direct"
                  >
              ...
              <div className="col contact-col animate__animated animate__slideInRight">
                <div className="instagram-wrapper">
                  ...
                  <p>berlianacahyar</p>
                  <a
                    href="https://www.instagram.com/berlianacahyar/"
                    target="_blank"
                    rel="noreferrer"
                    className="btn-direct"
                  >
