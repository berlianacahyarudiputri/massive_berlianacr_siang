...
import realProfile from "../assets/img/ber.png";
import hoverProfile from "../assets/img/lin.png";
...
function Home() {
  ...
  return (
    <>
      <HelmetProvider>
        <Helmet>
          <title>Berliana CR - Home</title>
        </Helmet>
      </HelmetProvider>
      <Container fluid className="home-wrapper">
        <div className="home-left animate__animated animate__fadeInLeft">
          <h3>
            Hi guys<img width="35" src={Hi} alt="Hi" />, my name is
          </h3>
          <h2>
            <span className="name-hover">Berliana</span>
            <br />
            <span className="name-hover">Cahya Rudiputri</span>
          </h2>
